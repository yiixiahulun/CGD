...
from .transformations import exp_map_from_origin, log_map_from_origin
...
try:
    ...
    def _jax_not_found(*args: Any, **kwargs: Any) -> Any:
        raise ImportError("JAX backend is not available. Please install JAX.")

    get_chaos_origin_jax = distance_FR_jax = log_map_from_origin_jax = (
        exp_map_from_origin_jax
    ) = _jax_not_found
